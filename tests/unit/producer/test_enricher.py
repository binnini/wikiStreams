...
mock_cache_response_mixed = {
    "Q123": {"label": "Cache Label 123", "description": "Cache Desc 123"}
}
mock_api_response_mixed = {
    "entities": {
        "Q456": {
            "labels": {"ko": {"value": "API Label 456"}},
            "descriptions": {"en": {"value": "API Desc 456"}},
        },
        "Q789": {
            "labels": {"en": {"value": "API Label 789"}},
            "descriptions": {"ko": {"value": "API Desc 789"}},
        },
    }
}
expected_mixed = [
    {
        "title": "Q123",
        "wikidata_label": "Cache Label 123",
        "wikidata_description": "Cache Desc 123",
    },
    {"title": "NonQID", "wikidata_label": None, "wikidata_description": None},
    {
        "title": "Q456",
        "wikidata_label": "API Label 456",
        "wikidata_description": "API Desc 456",
    },
    {
        "title": "Q123",
        "wikidata_label": "Cache Label 123",
    ...
    {
        "title": "Q789",
        "wikidata_label": "API Label 789",
        "wikidata_description": "API Desc 789",
    },
]
...
expected_api_error = [
    {"title": "Q123", "wikidata_label": None, "wikidata_description": None}
]

# 4. 엣지 케이스: ko 레이블 없음
mock_api_no_ko_label = {
...
@pytest.mark.parametrize(
    "test_id, events, cache_return, api_response, api_error, expected_events",
    [
        pytest.param(
            "cache_and_api",
            events_mixed,
        ...
        pytest.param(
            "no_qids", events_no_qids, {}, None, None, expected_no_qids, id="no_qids"
        ),
        pytest.param(
            "api_error",
            events_api_error,
        ...
        pytest.param(
            "edge_case_no_ko_label",
            [{"title": "Q1"}],
            {},
            mock_api_no_ko_label,
            None,
            expected_no_ko_label,
            id="edge_case_no_ko_label",
        ),
        pytest.param(
            "edge_case_no_valid_label",
            [{"title": "Q1"}],
            {},
            mock_api_no_valid_label,
            None,
            expected_no_valid_label,
            id="edge_case_no_valid_label",
        ),
        pytest.param(
            "edge_case_no_labels_field",
            [{"title": "Q1"}],
            {},
            mock_api_no_labels_field,
            None,
            expected_no_labels_field,
            id="edge_case_no_labels_field",
        ),
    ],
)
def test_enrich_scenarios(
    mocker,
    enricher,
    test_id,
    events,
    ...
    mock_get_cache = mocker.patch(
        "producer.enricher.get_qids_from_cache", return_value=cache_return
    )
    ...
    qids_in_batch = {
        e["title"]
        for e in events
        if e["title"].startswith("Q") and e["title"][1:].isdigit()
    }
