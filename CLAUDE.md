...
**사용 기술:**
- Python 3.11+, Redpanda (Kafka 호환), QuestDB 9.3.3, Grafana
...
Grafana 대시보드 3종 (컨테이너 시작 시 자동 프로비저닝):

- **Producer Performance** — 처리량(Events/Min), 캐시 적중률, 배치 처리 시간 (QuestDB)
- **WikiStreams Analytics** — 편집 트렌드, 위키별 통계, 네임스페이스 분포 (QuestDB)
- **WikiStreams SLO** — SLI/SLO 현황 (P1/P2/P5/P7/D1/D2/P3 — 전부 QuestDB 기반)
...
- **4단계 경량화**: Loki/Alloy 제거 완료 (2026-03-12). SLO 지표(P1/P7)를 QuestDB로 이관.
